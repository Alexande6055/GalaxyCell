...
export default function BrandsTopBar({ 
  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 mb-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Gestión de Marcas</h1>
          <p className="text-slate-500 text-sm">Administra los fabricantes de tus productos.</p>
        </div>
