...
export default function CategoryModal({ isOpen, editingCategory, onClose, onSubmit }: CategoryModalProps) {
      ...
      <div className="w-full max-w-md rounded-[2.5rem] bg-white shadow-2xl animate-in fade-in zoom-in duration-200 overflow-hidden">
        ...
        <div className="p-8">
          ...
          >
            ...
            {/* BOTONES CENTRADOS Y NORMALIZADOS */}
            <div className="mt-8 flex items-center justify-center gap-4 pt-2">
              ...
              >
                {editingCategory ? "Guardar" : "Registrar"}
              </button>
